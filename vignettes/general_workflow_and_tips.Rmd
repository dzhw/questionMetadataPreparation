...
#### Further checks, not strictly related to questions

While it's not strictly part of the workflow for preparing the question metadata, please check whether the instruments file provided by Zofar looks like the participants saw it. Meaning that buttons, headers and all languages etc are present. Also check whether all mandatory fields in the variables file are filled out.
